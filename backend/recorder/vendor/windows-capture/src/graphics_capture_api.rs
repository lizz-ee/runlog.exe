...
impl GraphicsCaptureApi {
    ...
    >(
        ...
        // Create frame pool
        // Free-threaded delivery keeps WGC frame acquisition independent of
        // this thread's Win32 message pump. A three-frame pool absorbs brief
        // compositor/encoder jitter without retaining WGC-owned surfaces.
