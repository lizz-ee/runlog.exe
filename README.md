...
Hover any spawn marker for per-spawn stats — survival rate, loot averages, kill counts, favorite weapon and shell, and your top enemy from runs at that spawn.
